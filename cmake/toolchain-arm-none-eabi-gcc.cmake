...
if (${CMAKE_HOST_WIN32})
    ...
    set(TOOLCHAIN_SHA256 "d287439b3090843f3f4e29c7c41f81d958a5323aecefcf705c203bfd8ae3f2e7")
elseif(${CMAKE_HOST_APPLE})
    ...
    set(TOOLCHAIN_SHA256 "fb613dacb25149f140f73fe9ff6c380bb43328e6bf813473986e9127e2bc283b")
else() # Linux
    ...
    set(TOOLCHAIN_SHA256 "97dbb4f019ad1650b732faffcc881689cedc14e2b7ee863d390e0a41ef16c9a3")
endif()

if (NOT EXISTS ${TOOLCHAIN_DIR})
    message(STATUS "Fetching ${TOOLCHAIN_URL}")
    file(DOWNLOAD ${TOOLCHAIN_URL} ${TOOLCHAIN_ARCHIVE} EXPECTED_HASH SHA256=${TOOLCHAIN_SHA256})
...
set(CMAKE_C_FLAGS "${COMMON_C_FLAGS_STR} -std=gnu11" CACHE STRING "" FORCE)
